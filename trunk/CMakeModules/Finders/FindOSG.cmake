...
# sprawdzenie
if (LIBRARY_OSG_LIBCORE_FOUND AND
	LIBRARY_OSG_LIBDB_FOUND AND
	LIBRARY_OSG_LIBUTIL_FOUND AND
	LIBRARY_OSG_LIBGA_FOUND AND
	LIBRARY_OSG_LIBVIEWER_FOUND AND
	LIBRARY_OSG_LIBTEXT_FOUND AND
	LIBRARY_OSG_LIBWIDGET_FOUND AND
	LIBRARY_OSG_PLUGINS_FOUND)
	
	FIND_DEPENDENCIES(OSG LIBRARY_OSG_FOUND "OPENTHREADS")
	FIND_PREREQUISITES(OSG LIBRARY_OSG_FOUND "LIBPNG;GIFLIB;LIBTIFF;QT;OPENSSL;SQLITE;GLUT;CURL;ZLIB")
	
	if(LIBRARY_OSG_FOUND)	
		# pluginy
		if ( WIN32 )	
