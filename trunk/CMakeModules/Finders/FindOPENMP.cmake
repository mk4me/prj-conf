...
if(UNIX)
  set(OPENMP_LIBRARY "gomp" CACHE INTERNAL "Biblioteka dla OpenMP")    
  set(OPENMP_LIBRARIES OPENMP_LIBRARY CACHE INTERNAL "Biblioteki dla OpenMP")
endif()
  ...
  set(OPENMP_FOUND 0 PARENT_SCOPE)
endif()
