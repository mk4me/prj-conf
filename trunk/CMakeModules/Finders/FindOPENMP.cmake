...
if(CMAKE_C_COMPILER_LOADED)
  ...
  if(OpenMP_C_FLAGS)
    ...
    include(Helpers/ConfigurationCheckCSourceCompiles)
  endif()
...
if(CMAKE_CXX_COMPILER_LOADED)
  ...
  if(OpenMP_CXX_FLAGS)
    ...
    include(Helpers/ConfigurationCheckCXXSourceCompiles)
...
if(_OPENMP_REQUIRED_VARS)
  ...
  set(OPENMP_COMPILER_FLAGS "" CACHE INTERNAL "Flagi kompilacji dla OpenMP")
  
if(UNIX)
  set(LIBRARY_OPENMP_LIBRARY "gomp" CACHE INTERNAL "Biblioteka dla OpenMP")    
  set(LIBRARY_OPENMP_LIBRARIES LIBRARY_OPENMP_LIBRARY CACHE INTERNAL "Biblioteki dla OpenMP")
endif()

  set(LIBRARY_OPENMP_FOUND 1)
  foreach(value ${_OPENMP_REQUIRED_VARS})
	list(APPEND OPENMP_COMPILER_FLAGS ${${value}})
  endforeach()  

  include(Helpers/ConfigurationFindPackageHandleStandardArgs)
  ...
  set(LIBRARY_OPENMP_FOUND 0 PARENT_SCOPE)
endif()
