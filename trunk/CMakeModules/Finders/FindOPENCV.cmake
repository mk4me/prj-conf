...
# sprawdzenie
if (LIBRARY_OPENCV_CALIB3D_FOUND AND 
    LIBRARY_OPENCV_CONTRIB_FOUND AND
    LIBRARY_OPENCV_CORE_FOUND AND
    LIBRARY_OPENCV_FEATURES2D_FOUND AND
    LIBRARY_OPENCV_FLANN_FOUND AND
    LIBRARY_OPENCV_GPU_FOUND AND
    LIBRARY_OPENCV_HIGHGUI_FOUND AND
    LIBRARY_OPENCV_IMGPROC_FOUND AND
    LIBRARY_OPENCV_LEGACY_FOUND AND
    LIBRARY_OPENCV_ML_FOUND AND
    LIBRARY_OPENCV_OBJDETECT_FOUND AND 
    LIBRARY_OPENCV_TS_FOUND AND
    LIBRARY_OPENCV_VIDEO_FOUND AND
	LIBRARY_OPENCV_NONFREE_FOUND)
		set(LIBRARY_OPENCV_FOUND 1)
else()
	set(LIBRARY_OPENCV_FOUND 0)
	message("Nie znaleziono którejœ z bibliotek OPENCV (wersje ${OPENCV_VERSION})")
endif()

if(LIBRARY_OPENCV_FOUND)
	if (WIN32)
		FIND_PREREQUISITES(OPENCV LIBRARY_OPENCV_FOUND "QT;FFMPEG;TBB")
	elseif (UNIX)
		FIND_DEPENDENCIES(OPENCV LIBRARY_OPENCV_FOUND "QT;FFMPEG;TBB")
	endif()
endif()
