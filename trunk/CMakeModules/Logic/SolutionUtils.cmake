...
macro(INITIALIZE_SOLUTION projectName)
	...
	elseif(UNIX)
		...
		SET(SOLUTION_CXX_FLAGS "-Os -std=c++1y -pthread -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C++")
		SET(SOLUTION_C_FLAGS "-Os -std=c++1y -pthread -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C")
