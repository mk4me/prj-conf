...
macro(INITIALIZE_SOLUTION projectName)
	...
	elseif(UNIX)
		...
		SET(SOLUTION_CXX_FLAGS "-Os -std=c++11 -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C++" FORCE)
		SET(SOLUTION_C_FLAGS "-Os -std=c++11 -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C" FORCE)
