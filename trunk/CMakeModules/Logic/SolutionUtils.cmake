...
macro(INITIALIZE_SOLUTION projectName)
	...
	if(WIN32)
		...
		SET(SOLUTION_CXX_FLAGS "/Zm500" CACHE STRING "Flagi kompilatora C++")
		SET(SOLUTION_C_FLAGS "/Zm500" CACHE STRING "Flagi kompilatora C")
	...
	elseif(UNIX)
		...
		SET(SOLUTION_CXX_FLAGS "-Os -std=c++1y -pthread -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C++" FORCE)
		SET(SOLUTION_C_FLAGS "-Os -std=c++1y -pthread -fpermissive -fPIC -m${SOLUTION_PROCESSOR_PLATFORM}" CACHE STRING "Flagi kompilatora C" FORCE)
