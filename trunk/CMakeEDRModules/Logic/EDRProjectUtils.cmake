...
if (WIN32)
	set(PROGRAM_FILES_DIR_TMP)
	GET_FILENAME_COMPONENT(PROGRAM_FILES_DIR_TMP  "[HKEY_LOCAL_MACHINE\\SOFTWARE\\PJWSTK\\MDE;ProgramFilesPath]" ABSOLUTE CACHE)	
	if(${PROGRAM_FILES_DIR_TMP} STREQUAL "/registry")
		message(WARNING "Aplikacja niezainstalowana - nie ma mo¿liwoœci testowania pluginów")
	else()
	...
	set(MDE_CORE_PATH ${PROJECT_BINARY_DIR}/../mde/bin CACHE PATH "Binary path.")
...
macro(FINALIZE_PLUGINS_SOLUTION)
	...
	if (WIN32)
		...
		GET_FILENAME_COMPONENT(PLUGINS_DEST  "[HKEY_LOCAL_MACHINE\\SOFTWARE\\PJWSTK\\MDE;ApplicationDataPath]" ABSOLUTE CACHE)
